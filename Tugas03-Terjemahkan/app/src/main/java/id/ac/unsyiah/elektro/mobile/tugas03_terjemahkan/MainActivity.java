...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickTerjemahkanAceh(View view) {
        ...
        String Peuhabadonya = getString(R.string.Aceh);
        textView.setText(Peuhabadonya);
    }

    public void onClickTerjemahkanIndonesia(View view) {
        TextView textView =
                (TextView) findViewById(R.id.textView);
        String Apakabardunia = getString(R.string.Indonesia);
        textView.setText(Apakabardunia);
    }

    public void onClickTerjemahkanInggris(View view) {
        TextView textView =
                (TextView) findViewById(R.id.textView);
        String Hellowworld = getString(R.string.Inggris);
